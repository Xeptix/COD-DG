...
public static class CommandLine
{
    ...
    {
        "steam", "depotdownloader", "game", "build", "manifest", "from", "to", "only", "files", "exe", "backup",
        "login", "username", "app", "depot", "out", "part",
    };
    ...
    public const string Commands = """
        Commands:
          ...
          undo <game>               Take a build back out of the installed game
    ...
    public static string Help(string version) => $"""
        ...
        Options:
          ...
          --again                   ingame: take the build already written in out first
