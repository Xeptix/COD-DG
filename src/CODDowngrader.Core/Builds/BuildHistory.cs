...
/// </summary>
/// <param name="Remembered">Known only from what the tool remembered on this PC, with no time a history can place.</param>
public sealed record KnownManifest(uint DepotId, ulong ManifestId, DateTimeOffset? FirstSeen, DateTimeOffset? Created, bool Installed, bool Latest, DateTimeOffset? Listed = null, bool Remembered = false);
